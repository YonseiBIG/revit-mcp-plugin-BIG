...
namespace revit_mcp_plugin.Core
{
    public class Application : IExternalApplication
    {
        ...
        {
            RibbonPanel mcpPanel = application.CreateRibbonPanel("Revit MCP-BIG");

            PushButtonData pushButtonData = new PushButtonData("ID_EXCMD_TOGGLE_REVIT_MCP_BIG", "MCP-BIG\r\n Switch",
                Assembly.GetExecutingAssembly().Location, "revit_mcp_plugin.Core.MCPServiceConnection");
            pushButtonData.ToolTip = "Open / Close MCP-BIG server";
            ...
            PushButtonData mcp_settings_pushButtonData = new PushButtonData("ID_EXCMD_MCP_BIG_SETTINGS", "Settings",
                Assembly.GetExecutingAssembly().Location, "revit_mcp_plugin.Core.Settings");
            mcp_settings_pushButtonData.ToolTip = "MCP-BIG Settings";
